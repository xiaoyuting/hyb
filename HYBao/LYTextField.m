...
-(void)layoutSubviews{
    ...
    _placeholderLabel.frame = CGRectMake(CGRectGetHeight(self.frame)-lineWidth, 0, CGRectGetWidth(self.frame), CGRectGetHeight(self.frame)-lineWidth);
    //_image.frame=CGRectMake(2, 2, CGRectGetHeight(self.frame)-4-lineWidth, CGRectGetHeight(self.frame)-4-lineWidth);
